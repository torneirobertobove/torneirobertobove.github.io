/* ADMIN DESKTOP V8 - leave sidebar navigation to admin-organization-v1 */
(function(){
  'use strict';
  ...
  function call(name){var fn=window[name];if(typeof fn!=='function')return false;try{return fn.apply(window,Array.prototype.slice.call(arguments,1));}catch(e){console.error('[ADMIN V8] '+name,e);return false;}}
  ...
  function bind(){
    var a=area();if(!a||a.dataset.adminNavBound==='v8')return;a.dataset.adminNavBound='v8';
    document.addEventListener('click',function(e){
      var b=e.target&&e.target.closest?e.target.closest('button,a,[role="button"]'):null;if(!b||!a.contains(b))return;
      /* Sidebar is controlled by admin-organization-v1.js (go()). */
      ...
      /* Nuovo torneo / Crea torneo is controlled by admin-function-fixes-v1.js. */
