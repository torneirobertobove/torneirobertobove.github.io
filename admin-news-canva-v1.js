...
function createFreePoster(download=true){const c=posterCanvas(),url=c.toDataURL('image/png');const a=document.createElement('a');a.href=url;a.download='locandina-next-point-padel.png';if(download){document.body.appendChild(a);a.click();a.remove()}return url}
...
function panel(){
 ...
 q('#naiFreePoster').onclick=()=>{createFreePoster(true);q('#naiCanvaStatus').textContent='Locandina PNG creata e scaricata gratuitamente. Puoi usarla direttamente oppure importarla in Canva Gratis.'};
