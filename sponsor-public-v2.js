...
(function(){
    ...
    function getBanner(){
        ...
        return track ? (track.closest('.sponsor-banner') || track.closest('.sponsor-banner-global')) : null;
    }

    function moveBannerToBottom(banner){
        if(!banner) return;
    ...
    function ensureBanner(){
        ...
        if(!banner){
            ...
            banner.classList.add('sponsor-banner-global');
        }
...
.sponsor-banner-global .sponsor-window{width:100%;overflow-x:auto;overflow-y:hidden;scrollbar-width:none;border-radius:16px}
.sponsor-banner-global .sponsor-window::-webkit-scrollbar{display:none}
.sponsor-banner-global .sponsor-track{display:flex;gap:12px;align-items:stretch;min-width:max-content;padding:2px}
...
.sponsor-banner-global .sponsor-logo{display:block;max-width:165px;max-height:50px;width:auto;height:auto;object-fit:contain;margin:auto}
.sponsor-banner-global .sponsor-name{font-weight:800;font-size:14px;letter-spacing:.4px}
.sponsor-banner-global .sponsor-video{font-size:10px;line-height:1.25;color:rgba(255,255,255,.78);margin-top:4px;max-width:100%;word-break:break-word}
.sponsor-banner-global .sponsor-empty{width:100%;text-align:center;color:rgba(255,255,255,.68);font-size:11px;padding:7px}
