...
`;
    ...
    function findTarget() {
        ...
        if (page.endsWith('/bove.html') || page.endsWith('bove.html')) {
            const ko = Array.from(document.querySelectorAll('.ko')).pop();
            if (ko) return ko;
            const groups = Array.from(document.querySelectorAll('.groups')).pop();
        ...
        return document.querySelector('.ko') || document.querySelector('.groups') || document.querySelector('main') || document.querySelector('.container');
    }
