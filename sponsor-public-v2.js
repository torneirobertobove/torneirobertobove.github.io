...
.sponsor-banner-global .sponsor-window{width:100%;overflow:hidden;border-radius:16px}.sponsor-banner-global .sponsor-track{display:flex;gap:12px;align-items:stretch;width:max-content;padding:2px;animation:sponsorGlobalScroll 24s linear infinite}
